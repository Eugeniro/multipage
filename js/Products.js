...
let ShowMoreButton=""
let HasShowMore=false,Scale=false;

function Showmore()
{
    if( document.documentElement.clientWidth<=500&& !HasShowMore)
    {
       HasShowMore=true;
    ...
    ShowMoreButton.addEventListener("click",()=>{
        ...
        ShowMoreButton.children[1].classList.toggle("Active_Sub_Menu_img")
