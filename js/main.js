...
function HeaderNavigation() {
    ...
    if (window.innerWidth>1024 && HeaderListenerFUNC.headMobShowClose) 
    {
        ...
        <source type="image/avif" srcset="Images/logo.avif 1x,Images/logo@2x.avif 2x, Images/logo@3x.avif 3x">
        <source type="image/webp" srcset="Images/logo.webp 1x,Images/logo@2x.webp 2x, Images/logo@3x.webp 3x">
...
HeaderNavigation()
/*Swap slide*/
const SlideSwap = document.querySelectorAll(".Top_radio_Item");
const SlideContainer = document.querySelector('.Slide_container')
SlideSwap.forEach((elem, index) => {
    elem.addEventListener("click", () => {
        for (let i = 0; i < SlideSwap.length; i++) {
            index === i ? elem.classList.add("ActiveTeam") : SlideSwap[i].classList.remove("ActiveTeam")
