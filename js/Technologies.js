    ...
    if (window.screen.width!==window.innerWidth)
    {
        ...
        <div class="Header_Mob">
            ...
            <div class="Header_Mob_Navigation">
                ...
                <ul>
                    ...
                    <li><a href="Technologies.html" class="Active_Page">TECHNOLOGIES</a> <svg data-index="1" class="Header_Mob_Navigation_arrow">
                        <use xlink:href="Images/Icons/arrowBlue.svg#ArrowBlue" />
                    </svg>
                        <ul class="Header_Mob_Sub_Navigation">
        ...
        <div class="Header_Navigation">
            <ul>
                ...
                <li class="Header_Navigation_item Active_Page"><a href="Technologies.html">TECHNOLOGIES</a> <svg class="Header_Navigation_arrow">
                    <use xlink:href="Images/Icons/arrowBlue.svg#ArrowBlue" />
                </svg>
                    <div class="Header_Navigation_Sub_Menu">
                        <ul>
...
/*faq*/
const FaqArrow=document.querySelectorAll('.faq_item_arrow_svg')
const FaqItem=document.querySelectorAll('.faq_sub_item')
FaqArrow.forEach((e,index)=>{
  e.addEventListener("click",()=>{
      e.classList.toggle("Active_Faq_arrow")
      FaqItem[index].classList.toggle("Active_Faq_item")
  })
})
/*resize*/
